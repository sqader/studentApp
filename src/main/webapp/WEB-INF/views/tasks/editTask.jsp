      ...
      <c:forEach items="${student}" var="title">
          <option value="${title.id}">${title.firstName} ${title.lastName}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                <textarea class="form-control" rows="5" id="start" name="description" placeholder="tutaj opisz zadanie...">${task.description}</textarea>
                                </div>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form method="post" action='<c:url value="/remove/${task.id}"/>'>
