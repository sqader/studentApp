                                ...
                                <div class="card mb-4 py-3 border-left-${item.color}">
                                    <div class="card-body">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">${item.studentModel.firstName} ${item.studentModel.lastName}
                                            | <strong>Dodano:</strong> <fmt:formatDate pattern = "yyyy-MM-dd" value = "${item.creationDate}" /> | <strong>Deadline:</strong> <fmt:formatDate pattern = "yyyy-MM-dd" value = "${item.deadline}" /></div>
                                            ${item.description}
                                    </div>
                                </div>
                            </a>
